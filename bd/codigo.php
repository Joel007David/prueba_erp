...
define('DB_HOST', 'anonfisi.informaticapp.com:3306');
define('DB_DATABASE', 'app_anonfisi');
define('DB_USER', 'app_anonfisi');
define('DB_PASSWORD', '.app_anonfisi-');
...
CREATE PROCEDURE PA_Ingresar_Aseguradora_de_Salud (
	...
	INSERT INTO  Aseguradora_de_Salud (Cod_Aseguradora_de_Salud,Aseguradora_de_Salud,Descripcion_Aseguradora_de_Salud,
                                       Porcentaje_Cobro_Aseguradora_de_Salud,Estado_Aseguradora_de_Salud) 
...
CREATE PROCEDURE PA_Modificar_Afp (
	...
	UPDATE Afp
	SET	Afp = _Afp_,Descripcion_Afp = Descripcion_Afp_,Porcentaje_Cobro_Afp = Porcentaje_Cobro_Afp_
...
CREATE PROCEDURE PA_Ingresar_Persona (
	...
	INSERT INTO Persona	(	Cod_Persona,Cod_Ciudad_Nacimiento,Cod_Ciudad_Direccion,Cod_Estado_Civil,Cod_Afp,Cod_Tipo_Persona,Nombres,Apellido_Paterno,Apellido_Materno,Dni,Email,
	...
	VALUES	(   NULL,Cod_Ciudad_Nacimiento_,Cod_Ciudad_Direccion_,Cod_Estado_Civil_,Cod_Afp_,Cod_Tipo_Persona_,Nombres_,Apellido_Paterno_,Apellido_Materno_,Dni_,Email_,Direccion_,
...
CREATE PROCEDURE PA_Modificar_Persona (
    ...
    IN Deporte_Favorito_ varchar(50),
    IN Foto_Persona_ varchar(255),
    IN Observacion_Persona varchar(255)  
)
	UPDATE Persona
...
CREATE PROCEDURE PA_Buscar_Derecho_Habiente()			
	...
	WHERE	Derecho_Habiente.Cod_Ciudad_Nacimiento_DH = Ubigeo.Cod_Ciudad AND
            Derecho_Habiente.Cod_Ciudad_Direccion_DH = Ubigeo.Cod_Ciudad AND
...
CREATE PROCEDURE PA_Ingresar_Empleado_Aseguradora (
	...
	INSERT INTO Empleado_Aseguradora (	Cod_Aseguradora_de_Salud, Cod_Persona, Fecha_Inscripcion_EA, 
										Fecha_Termino_EA, Porcentaje_Cobro_EA, Observacion_EA
										) 
...
;
CREATE PROCEDURE PA_Ingresar_Boleta (
    IN Cod_Persona_ int,
    IN Fecha_Inicio_B_ date,
    IN Fecha_Fin_B_ date,
    IN Fecha_Pago_B_ datetime
)
	INSERT INTO Boleta (Cod_Boleta,Cod_Persona,Fecha_Inicio_B,Fecha_Fin_B,Fecha_Pago_B,Estado_Boleta) 
	VALUES (NULL,Cod_Persona_,Fecha_Inicio_B_,Fecha_Fin_B_,Fecha_Pago_B_,1)
;
...
CREATE PROCEDURE PA_Ingresar_Habitacion (
	...
	INSERT INTO Habitacion (Cod_Habitacion,Num_Habitacion,Piso,Detalle_Habitacion,Precio_Habitacion,Estado_Habitacion) 
	VALUES (NULL,Num_Habitacion_,Piso_,Detalle_Habitacion_,Precio_Habitacion_,1) 
;
CREATE PROCEDURE PA_Modificar_Habitacion (
	...
	UPDATE Habitacion
	SET		Num_Habitacion = Num_Habitacion_, Piso = Piso_, Detalle_Habitacion = Detalle_Habitacion_, 
...
CREATE TABLE Tipo_Servicio (
    Cod_Tipo_Servicio int AUTO_INCREMENT,
    Tipo_Servicio varchar(255),
    Estado_Tipo_Servicio int(1),
    CONSTRAINT PK_Tipo_Servicio PRIMARY KEY (Cod_Tipo_Servicio)
)
;
CREATE PROCEDURE PA_Buscar_Tipo_Servicio()
	SELECT * 
	FROM Tipo_Servicio
    WHERE Estado_Tipo_Servicio = 1
;
CREATE PROCEDURE PA_Ingresar_Tipo_Servicio (
    IN Tipo_Servicio_ varchar(255)
)
	INSERT INTO Tipo_Servicio (Cod_Tipo_Servicio,Tipo_Servicio,Estado_Tipo_Servicio) 
	VALUES (NULL,Tipo_Servicio_,1)
;
CREATE PROCEDURE PA_Modificar_Tipo_Servicio (
    IN Cod_Tipo_Servicio_ int,
    IN Tipo_Servicio_ varchar(255)
)
	UPDATE Tipo_Servicio
	SET	Tipo_Servicio =Tipo_Servicio_
	WHERE Cod_Tipo_Servicio = Cod_Tipo_Servicio_
;
CREATE PROCEDURE PA_Eliminar_Tipo_Servicio (
    IN Cod_Servicio_ int
)
	UPDATE Tipo_Servicio
	SET Estado_Tipo_Servicio = 0
	WHERE Cod_Tipo_Servicio = Cod_Tipo_Servicio_
;
CREATE PROCEDURE PA_Suprimir_Tipo_Servicio (
    IN Cod_Tipo_Servicio_ int
)
...
CREATE TABLE Servicio (
    ...
    CONSTRAINT FK_Tipo_Servicio_Servicio FOREIGN KEY (Cod_Tipo_Servicio) REFERENCES Tipo_Servicio (Cod_Tipo_Servicio)
)
;
CREATE PROCEDURE PA_Buscar_Servicio()			
	SELECT * 
	FROM Servicio,Tipo_Servicio
	WHERE Servicio.Cod_Tipo_Servicio = Tipo_Servicio.Cod_Tipo_Servicio AND Estado_Servicio = 1
;
CREATE PROCEDURE PA_Ingresar_Servicio (
	...
	INSERT INTO Servicio (Cod_Servicio,Cod_Tipo_Servicio,Servicio,Precio_Servicio,Estado_Servicio) 
	VALUES (NULL,Cod_Tipo_Servicio_,Servicio_,Precio_Servicio_,1) 
;
CREATE PROCEDURE PA_Modificar_Servicio (
	...
	UPDATE Servicio
	SET	Cod_Tipo_Servicio = Cod_Tipo_Servicio_,Servicio = Servicio_,Precio_Servicio = Precio_Servicio_
...
CREATE TABLE Detalle_Servicio (
    ...
    CONSTRAINT PK_Detalle_Servicio PRIMARY KEY (Cod_Servicio,Cod_Estadia),
...
CREATE PROCEDURE PA_Ingresar_Movimiento (
	...
	INSERT INTO Movimiento (Cod_Movimiento,Cod_Concepto_Movimiento,Cod_Forma_Pago,Cod_Tipo_Documento,Cod_Caja,Cod_Persona,Fecha_Inicio_Caja_Persona,Cod_Tipo_Sis,Monto_Movimiento,Fecha_Movimiento,Estado_Movimiento) 
	VALUES (NULL,Cod_Concepto_Movimiento_,Cod_Forma_Pago_,Cod_Tipo_Documento_,Cod_Caja_,Cod_Persona_,Fecha_Inicio_Caja_Persona_,Cod_Tipo_Sis_,Monto_Movimiento_,Fecha_Movimiento_,1)
;
CREATE PROCEDURE PA_Modificar_Movimiento (
	...
	SET Cod_Concepto_Movimiento = Cod_Concepto_Movimiento_,Cod_Forma_Pago = Cod_Forma_Pago_,Cod_Tipo_Documento = Cod_Tipo_Documento_,
		Cod_Caja = Cod_Caja_,Cod_Persona = Cod_Persona_,Fecha_Inicio_Caja_Persona = Fecha_Inicio_Caja_Persona_,Cod_Tipo_Sis = Cod_Tipo_Sis_,Monto_Movimiento = Monto_Movimiento_,Fecha_Movimiento = Fecha_Movimiento_
...
CREATE PROCEDURE PA_Ingresar_Producto (
    ...
    IN Fecha_Vencimiento_Producto_ date,
    IN Stock_Producto_ int,
    IN Stock_Minimo_ int,
    IN Stock_Maximo_ int  
)
	INSERT INTO Productos (Cod_Producto,Cod_Tipo_Producto,Cod_Marca,Producto,Descripcion_Producto,Precio_Producto,Fecha_Vencimiento_Producto,Stock_Producto,Stock_Minimo,Stock_Maximo,Estado_Producto) 
	VALUES (NULL,Cod_Tipo_Producto_,Cod_Marca_,Producto_,Descripcion_Producto_,Precio_Producto_,Fecha_Vencimiento_Producto_,Stock_Producto_,Stock_Minimo_,Stock_Maximo_,1)
;
CREATE PROCEDURE PA_Modificar_Producto (
	...
	UPDATE Productos
	SET	Cod_Tipo_Producto = Cod_Tipo_Producto_, Cod_Marca = Cod_Marca_, Producto = Producto_,Descripcion_Producto = Descripcion_Producto_,Precio_Producto = Precio_Producto_,Fecha_Vencimiento_Producto = Fecha_Vencimiento_Producto_, Stock_Producto = Stock_Producto_,
