...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if($codigo == ''){ echo 'Nuevo Afp'; }else{ echo 'Modificar Afp'; } ?></title>            
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php if($codigo == ''){ echo 'Nuevo Afp'; }else{ echo 'Modificar Afp'; } ?></li>
                </ul>
                <!-- END BREADCRUMB -->                
                ...
                <div class="page-title">  
					...
					?>
						<h2><span class="fa fa-arrow-circle-o-left"></span> Modificar Afp</h2>
                    <?php
						$mysqli = new mysqli(DB_HOST,DB_USER,DB_PASSWORD,DB_DATABASE);
						$sql = "CALL PA_Buscar_Afp_Codigo({$_GET['codigo']})";
						$execute = $mysqli->query($sql);
						$mysqli->close();
						$data = mysqli_fetch_array($execute);
						$enlace = "m&&codigo=".$data['Cod_Afp'];
					}
					?>
                </div>                   
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="afp" value="<?php if($codigo != ''){ echo $data['Afp']; } ?>" placeholder="Ingrese el Nombre de Afp" autofocus required/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Descripcion de Afp</label>
                                    <div class="col-md-6">
                                        <textarea class="form-control" name="descripcion_afp" rows="5" placeholder="Ingrese una Descripcion del Afp"><?php if($codigo != ''){ echo $data['Descripcion_Afp']; } ?></textarea>
                                    </div>
                                </div>                       
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                            <input type="text" class="form-control" name="porcentaje_cobro_afp" value="<?php if($codigo != ''){ echo $data['Porcentaje_Cobro_Afp']; } ?>" placeholder="Ingrese el Porcentaje de Cobro del Afp"/>
                                        </div>
                                    </div>
                                </div>
