...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if($codigo == ''){ echo 'Nueva Aseguradora de Salud'; }else{ echo 'Modificar Aseguradora de Salud'; } ?></title>            
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php if($codigo == ''){ echo 'Nueva Aseguradora de Salud'; }else{ echo 'Modificar Aseguradora de Salud'; } ?></li>
                </ul>
                <!-- END BREADCRUMB -->                
                ...
                <div class="page-title">  
					...
					if($codigo == ''){
					?>                  
                    	<h2><span class="fa fa-arrow-circle-o-left"></span> Ingresar una nueva Aseguradora de Salud</h2>
                    <?php
						$enlace = 'i';
					}else{
					?>
						<h2><span class="fa fa-arrow-circle-o-left"></span> Modificar Aseguradora de Salud</h2>
                    <?php
						$mysqli = new mysqli(DB_HOST,DB_USER,DB_PASSWORD,DB_DATABASE);
						$sql = "CALL PA_Buscar_Aseguradora_de_Salud_Codigo({$_GET['codigo']})";
						$execute = $mysqli->query($sql);
						$mysqli->close();
						$data = mysqli_fetch_array($execute);
						$enlace = "m&&codigo=".$data['Cod_Aseguradora_de_Salud'];
					}
					?>
                </div>                   
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-8" >
                            ...
                            <form method="post" action="../bd/phpbase.php?table=aseguradora_de_salud&&tipo=<?php echo $enlace ?>" class="form-horizontal" name="aseguradora_de_salud" role="form"> 
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Aseguradora de Salud</label>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                            <input type="text" class="form-control" name="aseguradora_de_salud" value="<?php if($codigo != ''){ echo $data['Aseguradora_de_Salud']; } ?>" placeholder="Ingresar Nombre de Aseguradora de Salud" autofocus required />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Descripcion de Aseguradorad de Salud</label>
                                    <div class="col-md-6">
                                        <textarea class="form-control" name="descripcion_aseguradora_de_salud" rows="5" placeholder="Ingresar Descripcion de Aseguradora de Salud"><?php if($codigo != ''){ echo $data['Descripcion_Aseguradora_de_Salud']; } ?></textarea>
                                    </div>
                                </div>                       
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Porcentaje de Cobro</label>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                            <input type="text" class="form-control" name="porcentaje_cobro_aseguradora_de_salud" value="<?php if($codigo != ''){ echo $data['Porcentaje_Cobro_Aseguradora_de_Salud']; } ?>" placeholder="Ingresar Porcentaje de Cobro" required />
                                        </div>
                                    </div>
                                </div>
