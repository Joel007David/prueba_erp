...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if($codigo == ''){ echo 'Nuevo Cargo'; }else{ echo 'Modificar Cargo'; } ?></title>            
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php if($codigo == ''){ echo 'Nuevo Cargo'; }else{ echo 'Modificar Cargo'; } ?></li>
                </ul>
                <!-- END BREADCRUMB -->                
                ...
                <div class="page-title">  
					...
					if($codigo == ''){
					?>                  
                    	<h2><span class="fa fa-arrow-circle-o-left"></span> Ingresar un nuevo Cargo</h2>
                    <?php
						$enlace = 'i';
					}else{
					?>
						<h2><span class="fa fa-arrow-circle-o-left"></span> Modificar Cargo</h2>
                    <?php
						$mysqli = new mysqli(DB_HOST,DB_USER,DB_PASSWORD,DB_DATABASE);
						$sql = "CALL PA_Buscar_Cargo_Codigo({$_GET['codigo']})";
						$execute = $mysqli->query($sql);
						$mysqli->close();
						$data = mysqli_fetch_array($execute);
						$enlace = "m&&codigo=".$data['Cod_Cargo'];
					}
					?>
                </div>                   
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-8" >
                            ...
                            <form method="post" action="../bd/phpbase.php?table=cargo&&tipo=<?php echo $enlace ?>" class="form-horizontal" name="cargo" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="cargo" value="<?php if($codigo != ''){ echo $data['Cargo']; } ?>" placeholder="Ingrese el Nombre del Cargo" autofocus required />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">                                                                                
                                        <select class="form-control select" data-live-search="true" name="cod_area">
                                            <?php
                                            $mysqli = new mysqli(DB_HOST,DB_USER,DB_PASSWORD,DB_DATABASE);
                                            $sql = "CALL PA_Buscar_Area";
                                            $execute = $mysqli->query($sql);
                                            while ($data_area = mysqli_fetch_array($execute)) {
                                            ?>
                                            <option value="<?php echo $data_area['Cod_Area'] ?>"
                                            <?php 	if($codigo != '' and $data['Cod_Area'] == $data_area['Cod_Area'] ){ 
															echo 'selected';
													} 
											?>        
                                            >
                                                <?php echo $data_area['Area'] ?>
                                            </option>
                                            <?php
                                            }$mysqli->close();
                                            ?>
