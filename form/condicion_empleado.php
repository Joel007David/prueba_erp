...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if($codigo == ''){ echo 'Nuevo Condición de Empleado'; }else{ echo 'Modificar Condición de Empleado'; } ?></title>            
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php if($codigo == ''){ echo 'Nuevo Condición de Empleado'; }else{ echo 'Modificar Condición de Empleado'; } ?></li>
                </ul>
                <!-- END BREADCRUMB -->                
                ...
                <div class="page-title">  
					...
					if($codigo == ''){
					?>                  
                    	<h2><span class="fa fa-arrow-circle-o-left"></span> Ingresar una nueva Condición de Empleado</h2>
                    <?php
						$enlace = 'i';
					}else{
					?>
						<h2><span class="fa fa-arrow-circle-o-left"></span> Modificar Condición de Empleado</h2>
                    <?php
						$mysqli = new mysqli(DB_HOST,DB_USER,DB_PASSWORD,DB_DATABASE);
						$sql = "CALL PA_Buscar_Condicion_Empleado_Codigo({$_GET['codigo']})";
						$execute = $mysqli->query($sql);
						$mysqli->close();
						$data = mysqli_fetch_array($execute);
						$enlace = "m&&codigo=".$data['Cod_Condicion_Empleado'];
					}
					?>
                </div>                   
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-8" >
                            ...
                            <form method="post" action="../bd/phpbase.php?table=condicion_empleado&&tipo=<?php echo $enlace ?>" class="form-horizontal" name="condicion_empleado" role="form">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Condicion de Empleado</label>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                            <input type="text" class="form-control" name="condicion_empleado" value="<?php if($codigo != ''){ echo $data['Condicion_Empleado']; } ?>" placeholder="Ingrese el Nombre de Condicion de Empleado" autofocus required />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Descripcion de Condicion de Empleado</label>
                                    <div class="col-md-6">
                                        <textarea class="form-control" name="descripcion_condicion_empelado" rows="5"><?php if($codigo != ''){ echo $data['Descripcion_Condicion_Empleado']; } ?></textarea>
                                    </div>
                                </div>
