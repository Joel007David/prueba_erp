...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if($codigo == ''){ echo 'Nueva Contrato'; }else{ echo 'Modificar Contrato'; } ?></title>            
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li><a href="../gestion_de_contratos.php">Gestión de Contratos </a></li>                    
                    <li class="active"><?php if($codigo == ''){ echo 'Nueva Contrato'; }else{ echo 'Modificar Contrato'; } ?></li>
                </ul>
                <!-- END BREADCRUMB -->                
                ...
                <div class="page-title">  
					...
					if($codigo == ''){
					?>                  
                    	<h2><span class="fa fa-arrow-circle-o-left"></span> Ingresar una nuevo Contrato</h2>
                    <?php
						$enlace = 'i';
					}else{
					?>
						<h2><span class="fa fa-arrow-circle-o-left"></span> Modificar Contrato</h2>
                    <?php
						$mysqli = new mysqli(DB_HOST,DB_USER,DB_PASSWORD,DB_DATABASE);
						$sql = "CALL PA_Buscar_Contrato_Codigo({$_GET['codigo']})";
						$execute = $mysqli->query($sql);
						$mysqli->close();
						$data = mysqli_fetch_array($execute);
						$enlace = "m&&codigo=".$data['Cod_Contrato'];
					}
					?>
                </div>                   
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-8" >
                            ...
                            <form method="post" action="../bd/phpbase.php?table=contrato&&tipo=<?php echo $enlace ?>" class="form-horizontal" name="contrato" role="form">   
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">                                                                                
                                        <select class="form-control select" data-live-search="true" name="cod_cargo">
                                            <?php
                                            $mysqli = new mysqli(DB_HOST,DB_USER,DB_PASSWORD,DB_DATABASE);
                                            $sql = "CALL PA_Buscar_Cargo";
                                            $execute = $mysqli->query($sql);
                                            while ($data_cargo = mysqli_fetch_array($execute)) {
                                            ?>
                                            <option value="<?php echo $data_cargo['Cod_Cargo'] ?>"
                                            <?php 	if($codigo != '' and $data['Cod_Cargo'] == $data_cargo['Cod_Cargo'] ){ 
															echo 'selected';
													} 
											?>
                                            >
                                                <?php echo $data_cargo['Cargo'] ?>
                                            </option>
                                            <?php
                                            }$mysqli->close();
                                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">                                                                                
                                        <select class="form-control select" data-live-search="true" name="cod_tipo_contrato" required>
                                            <?php
                                            $mysqli = new mysqli(DB_HOST,DB_USER,DB_PASSWORD,DB_DATABASE);
                                            ...
                                            ?>
                                            <option value="<?php echo $data_tipo_contrato['Cod_Tipo_Contrato'] ?>"
                                            <?php 	if($codigo != '' and $data['Cod_Tipo_Contrato'] == $data_tipo_contrato['Cod_Tipo_Contrato'] ){ 
															echo 'selected';
													} 
											?>
                                            >
                                                <?php echo $data_tipo_contrato['Tipo_Contrato'] ?>
                                            </option>
                                            <?php
                                            }$mysqli->close();
                                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <input type="text" class="form-control datepicker" value="<?php if($codigo != ''){ echo $data['Fecha_Inicio_C']; }else{ echo '2014-06-11';} ?>" name="fecha_inicio_c" required/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <input type="text" class="form-control datepicker" value="<?php if($codigo != ''){ echo $data['Fecha_Fin_C']; }else{ echo '2014-06-11';} ?>" name="fecha_fin_c" required/>
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="sueldo_c" value="<?php if($codigo != ''){ echo $data['Sueldo_C']; } ?>" required/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Días de Trabajo</label>
                                    <div class="col-md-6">
                                        <input type="number" min="0" class="form-control" name="dias_trabajo" value="<?php if($codigo != ''){ echo $data['Dias_Trabajo']; } ?>" />
                                    </div>
                                </div>
