        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
							<form class="form-horizontal" method="post" name="empleado" action="../bd/phpbase.php?table=empleado&&tipo=<?php echo $enlace ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">                                            
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control campos" value="<?php if($codigo != ''){ echo $data['Apellido_Paterno']; } ?>" name="apellido_paterno" maxlength="30" placeholder="Ingresar el Apellido Paterno" autofocus required/>
                                                    </div> 
                                                </div>
                                            </div>
