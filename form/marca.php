...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if($codigo == ''){ echo 'Nueva Marca'; }else{ echo 'Modificar Marca'; } ?></title>            
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php if($codigo == ''){ echo 'Nueva Marca'; }else{ echo 'Modificar Marca'; } ?></li>
                </ul>
                <!-- END BREADCRUMB -->                
                ...
                <div class="page-title">  
					...
					if($codigo == ''){
					?>                  
                    	<h2><span class="fa fa-arrow-circle-o-left"></span> Ingresar una nueva Marca</h2>
                    <?php
						$enlace = 'i';
					}else{
					?>
						<h2><span class="fa fa-arrow-circle-o-left"></span> Modificar Marca</h2>
                    <?php
						$mysqli = new mysqli(DB_HOST,DB_USER,DB_PASSWORD,DB_DATABASE);
						$sql = "CALL PA_Buscar_Marca_Codigo({$_GET['codigo']})";
						$execute = $mysqli->query($sql);
						$mysqli->close();
						$data = mysqli_fetch_array($execute);
						$enlace = "m&&codigo=".$data['Cod_Marca'];
					}
					?>
                </div>                   
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-8" >
                            ...
                            <form method="post" action="../bd/phpbase.php?table=marca&&tipo=<?php echo $enlace ?>" class="form-horizontal" name="marca" role="form">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Marca</label>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                            <input type="text" class="form-control" name="marca" value="<?php if($codigo != ''){ echo $data['Marca']; } ?>" placeholder="Ingrese el Nombre de la Marca" autofocus required />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Descripcion de la Marca</label>
                                    <div class="col-md-6">
                                        <textarea class="form-control" name="descripcion_marca" rows="5" placeholder="Ingrese una Descripcion de la Marca"><?php if($codigo != ''){ echo $data['Descripcion_Marca']; } ?></textarea>
                                    </div>
                                </div>
