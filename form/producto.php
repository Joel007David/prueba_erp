...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if($codigo == ''){ echo 'Nuevo Producto'; }else{ echo 'Modificar Producto'; } ?></title>            
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php if($codigo == ''){ echo 'Nuevo Producto'; }else{ echo 'Modificar Producto'; } ?></li>
                </ul>
                <!-- END BREADCRUMB -->                
                ...
                <div class="page-title">  
					...
					if($codigo == ''){
					?>                  
                    	<h2><span class="fa fa-arrow-circle-o-left"></span> Ingresar un nuevo Producto</h2>
                    <?php
						$enlace = 'i';
					}else{
					?>
						<h2><span class="fa fa-arrow-circle-o-left"></span> Modificar Producto</h2>
                    <?php
						$mysqli = new mysqli(DB_HOST,DB_USER,DB_PASSWORD,DB_DATABASE);
						$sql = "CALL PA_Buscar_Producto_Codigo({$_GET['codigo']})";
						$execute = $mysqli->query($sql);
						$mysqli->close();
						$data = mysqli_fetch_array($execute);
						$enlace = "m&&codigo=".$data['Cod_Producto'];
					}
					?>
                </div>                   
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-8" >
                            ...
                            <form method="post" action="../bd/phpbase.php?table=producto&&tipo=<?php echo $enlace ?>" class="form-horizontal" name="producto" role="form">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Producto</label>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                            <input type="text" class="form-control" name="producto" value="<?php if($codigo != ''){ echo $data['Producto']; } ?>" placeholder="Ingrese el Nombre del Producto" autofocus required />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select" data-live-search="true" name="cod_marca">
                                            <?php
                                            $mysqli = new mysqli(DB_HOST,DB_USER,DB_PASSWORD,DB_DATABASE);
                                            ...
                                            ?>
                                            <option value="<?php echo $data_marca['Cod_Marca'] ?>"
                                            <?php 	if($codigo != '' and $data['Cod_Marca'] == $data_marca['Cod_Marca'] ){ 
															echo 'selected';
													} 
											?>  
                                            >
                                                <?php echo $data_marca['Marca'] ?>
                                            </option>
                                            <?php
                                            }$mysqli->close();
                                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select" data-live-search="true" name="cod_tipo_producto">
                                            <?php
                                            $mysqli = new mysqli(DB_HOST,DB_USER,DB_PASSWORD,DB_DATABASE);
                                            $sql = "CALL PA_Buscar_Tipo_Producto";
                                            $execute = $mysqli->query($sql);
                                            while ($data_tipo_producto = mysqli_fetch_array($execute)) {
                                            ?>
                                            <option value="<?php echo $data_tipo_producto['Cod_Tipo_Producto'] ?>"
                                            <?php 	if($codigo != '' and $data['Cod_Tipo_Producto'] == $data_tipo_producto['Cod_Tipo_Producto'] ){ 
															echo 'selected';
													} 
											?>
                                            >
                                                <?php echo $data_tipo_producto['Tipo_Producto'] ?>
                                            </option>
                                            <?php
                                            }$mysqli->close();
                                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <textarea class="form-control" name="descripcion_producto" rows="5" placeholder="Ingresar Descripcion del Producto"><?php if($codigo != ''){ echo $data['Descripcion_Producto']; } ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                            <input type="text" class="form-control" name="precio_producto" value="<?php if($codigo != ''){ echo $data['Precio_Producto']; } ?>" placeholder="Ingrese Precio del Producto" required/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Sotck</label>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                            <input type="number" min="0" class="form-control" name="stock_producto" value="<?php if($codigo != ''){ echo $data['Stock_Producto']; } ?>" placeholder="Ingrese Stock del Producto" required/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Sotck Mínimo</label>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                            <input type="numer" min="0" class="form-control" name="stock_minimo" value="<?php if($codigo != ''){ echo $data['Stock_Minimo']; } ?>"placeholder="Ingrese Stock Mínimo del Producto" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Sotck Máximo</label>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                            <input type="number" min="0" class="form-control" name="stock_maximo" value="<?php if($codigo != ''){ echo $data['Stock_Maximo']; } ?>" placeholder="Ingrese Stock Máximo del Producto"/>
                                        </div>
                                    </div>
                                </div>
