...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if($codigo == ''){ echo 'Nuevo Servicio'; }else{ echo 'Modificar Servicio'; } ?></title>            
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-open                    <li class="xn-openable">
able">
able">
            ...
            <div class="page-content">
                ...
                <div class="page-title">  
					...
					if($codigo == ''){
					?>                  
                    	<h2><span class="fa fa-arrow-circle-o-left"></span> Ingresar una nuevo Servicio</h2>
                    <?php
						$enlace = 'i';
					}else{
					?>
						<h2><span class="fa fa-arrow-circle-o-left"></span> Modificar Servicio</h2>
                    <?php
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-8" >
                            ...
                            <form method="post" action="../bd/phpbase.php?table=servicio&&tipo=<?php echo $enlace ?>" class="form-horizontal" name="servicio" role="form">   
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Servicio</label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="servicio" value="<?php if($codigo != ''){ echo $data['Servicio']; } ?>" autofocus required/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Precio</label>
                                    <div class="col-md-6">
                                        <input type="number" class="form-control" name="precio_servicio" value="<?php if($codigo != ''){ echo $data['Precio_Servicio']; } ?>" required/>
                                    </div>
                                </div>
