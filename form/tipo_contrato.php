...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if($codigo == ''){ echo 'Nuevo Tipo de Contrato'; }else{ echo 'Modificar Tipo de Contrato'; } ?></title>            
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php if($codigo == ''){ echo 'Nuevo Tipo de Contrato'; }else{ echo 'Modificar Tipo de Contrato'; } ?></li>
                </ul>
                <!-- END BREADCRUMB -->                
                ...
                <div class="page-title">  
					...
					if($codigo == ''){
					?>                  
                    	<h2><span class="fa fa-arrow-circle-o-left"></span> Ingresar un nuevo Tipo de Contrato</h2>
                    <?php
						$enlace = 'i';
					}else{
					?>
						<h2><span class="fa fa-arrow-circle-o-left"></span> Modificar Tipo de Contrato</h2>
                    <?php
						$mysqli = new mysqli(DB_HOST,DB_USER,DB_PASSWORD,DB_DATABASE);
						$sql = "CALL PA_Buscar_Tipo_Contrato_Codigo({$_GET['codigo']})";
						$execute = $mysqli->query($sql);
						$mysqli->close();
						$data = mysqli_fetch_array($execute);
						$enlace = "m&&codigo=".$data['Cod_Tipo_Contrato'];
					}
					?>
                </div>                   
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-8" >
                            ...
                            <form method="post" action="../bd/phpbase.php?table=tipo_contrato&&tipo=<?php echo $enlace ?>" class="form-horizontal" name="tipo_contrato" role="form"> 
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Tipo de Contrato</label>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                            <input type="text" class="form-control" name="tipo_contrato"  value="<?php if($codigo != ''){ echo $data['Tipo_Contrato']; } ?>" placeholder="Ingrese Nombre del Tipo de Contrato" autofocus required/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Descripcion del Tipo de Contrato</label>
                                    <div class="col-md-6">
                                        <textarea class="form-control" name="descripcion_tipo_contrato" rows="5" placeholder="Ingrese Descripcion del Tipo de Contrato"><?php if($codigo != ''){ echo $data['Descripcion_Tipo_Contrato']; } ?></textarea>
                                    </div>
                                </div>
