...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if($codigo == ''){ echo 'Nuevo Tipo de Habitación'; }else{ echo 'Modificar Tipo de Habitación'; } ?></title>            
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php if($codigo == ''){ echo 'Nuevo Tipo de Habitación'; }else{ echo 'Modificar Tipo de Habitación'; } ?></li>
                </ul>
                <!-- END BREADCRUMB -->                
                ...
                <div class="page-title">  
					...
					if($codigo == ''){
					?>                  
                    	<h2><span class="fa fa-arrow-circle-o-left"></span> Ingresar una Nuevo Tipo de Habitación</h2>
                    <?php
						$enlace = 'i';
					}else{
					?>
						<h2><span class="fa fa-arrow-circle-o-left"></span> Modificar Tipo de  Habitación</h2>
                    <?php
						$mysqli = new mysqli(DB_HOST,DB_USER,DB_PASSWORD,DB_DATABASE);
						$sql = "CALL PA_Buscar_Tipo_Habitacion_Codigo({$_GET['codigo']})";
						$execute = $mysqli->query($sql);
						$mysqli->close();
						$data = mysqli_fetch_array($execute);
						$enlace = "m&&codigo=".$data['Cod_Tipo_Habitacion'];
					}
					?>
                </div>                   
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-8" >
                            ...
                            <form method="post" action="../bd/phpbase.php?table=tipo_habitacion&&tipo=<?php echo $enlace ?>" class="form-horizontal" name="tipo_habitacion" role="form">   
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Tipo de Habitacion</label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" value="<?php if($codigo != ''){ echo $data['Tipo_Habitacion']; } ?>" name="tipo_habitacion" maxlength="30" placeholder="Ingresar Tipo de Habitación" autofocus required/>
                                    </div>
                                </div>
