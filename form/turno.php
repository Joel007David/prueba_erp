...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if($codigo == ''){ echo 'Nuevo Turno'; }else{ echo 'Modificar Turno'; } ?></title>            
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php if($codigo == ''){ echo 'Nuevo Turno'; }else{ echo 'Modificar Turno'; } ?></li>
                </ul>
                <!-- END BREADCRUMB -->                
                ...
                <div class="page-title">  
					...
					if($codigo == ''){
					?>                  
                    	<h2><span class="fa fa-arrow-circle-o-left"></span> Ingresar un nuevo Turno</h2>
                    <?php
						$enlace = 'i';
					}else{
					?>
						<h2><span class="fa fa-arrow-circle-o-left"></span> Modificar Turno</h2>
                    <?php
						$mysqli = new mysqli(DB_HOST,DB_USER,DB_PASSWORD,DB_DATABASE);
						$sql = "CALL PA_Buscar_Turno_Codigo({$_GET['codigo']})";
						$execute = $mysqli->query($sql);
						$mysqli->close();
						$data = mysqli_fetch_array($execute);
						$enlace = "m&&codigo=".$data['Cod_Turno'];
					}
					?>
                </div>                   
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-8" >
                            ...
                            <form method="post" action="../bd/phpbase.php?table=turno&&tipo=<?php echo $enlace ?>" class="form-horizontal" name="turno" role="form"> 
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Turno</label>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                                            <input type="text" class="form-control" name="turno" value="<?php if($codigo != ''){ echo $data['Turno']; } ?>" placeholder="Ingresar Nombre del Turno" autofocus required />
                                         </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group bootstrap-timepicker">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                                            <input type="text" class="form-control timepicker" name="hora_inicio_turno" value=""/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group bootstrap-timepicker">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                                            <input type="text" class="form-control timepicker" name="hora_fin_turno" value="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Observacion del Turno</label>
                                    <div class="col-md-6">
                                        <textarea class="form-control" name="observacion_turno" rows="5" placeholder="Ingresar Observación del Turno"><?php if($codigo != ''){ echo $data['Observacion_Turno']; } ?></textarea>
                                    </div>
                                </div>
